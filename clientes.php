...
<?php
    if ($_POST['solicitud'] == '0'){
        ...
        if($insert){
            ...
            $debe = $total;
            $sql2 = "INSERT INTO pagos VALUES('$solicitud', '$precio', '$alicuota', '$derechoadm', '$cargoadm', '$sellado', '$total', '$abono','$debe', '$cuotaS', '$monto', '$vencimiento', 'No hay observaciones', '1', '0', '0', 'D', '$cuotas', '0')";
            ...
            if ($cuotas < 68){
                for ($i=1; $i<$cuotas; $i++){
                    ...
                    $sql2 = "INSERT INTO cuotas VALUES('$solicitud', '$i', '$monto', 'ESPERA')";
                    $insert2 = mysqli_query($conexion, $sql2);
                }
            }else{
                for ($i=1; $i<$cuotas; $i++){
