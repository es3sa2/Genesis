      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white " href="usuario.php">
            ...
            <span class="nav-link-text ms-1">Mis cuotas</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="#.php">
            ...
            <span class="nav-link-text ms-1">Pagar</span>
          </a>
        </li>
      </ul>
    </div>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group input-group-outline">
              <label class="form-label">Nro de solicitud</label>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><?php echo $_SESSION['mail'];?></span>
              </a>
            </li>
